...
💌Зворотній зв’язок
Сподіваємося, що наш бот став для вас корисним помічником. Якщо у вас є пропозиції, що додати, змінити або ж поділитися враженнями від користування, то пишіть нам @sumka_feedback_bot
"""
